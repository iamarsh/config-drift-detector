    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 flex gap-4">
          <div>
            <label htmlFor="s3-severity-filter" className="block text-sm font-medium text-text-secondary mb-2">
              Severity
            </label>
            <select
              id="s3-severity-filter"
          ...
          <div>
            <label htmlFor="s3-status-filter" className="block text-sm font-medium text-text-secondary mb-2">
              Status
            </label>
            <select
              id="s3-status-filter"
